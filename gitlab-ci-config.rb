...
GITLABCI_CODEQUALITY_CLANGTIDY_IGNORECHECKS="modernize-use-trailing-return-type;hicpp-deprecated-headers;modernize-deprecated-headers;modernize-use-using"
